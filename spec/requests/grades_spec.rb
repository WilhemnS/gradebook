...
RSpec.describe "/grades", type: :request do
  ...
  # Signed in as a Teacher Assistant user
  context "When signed in as a TA" do
    before do 
      @user = User.create(email: "teacher@gmail.com", password: "default123", account_id: 0)
      sign_in @user
    ...
    describe "Not allowed to DELETE /destroy" do
      it " doesn't destroy the requested grade" do
        expect {
          delete grade_url(@grade)
        }.to change(Grade, :count).by(0)
